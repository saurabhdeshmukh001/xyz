// // pages/Cart.jsx (Optimistic UI and Smoothness Fix)
// import React, { useState, useEffect } from "react";
// import { useNavigate } from 'react-router-dom';
// import Navbar from "../components/Navbar";
// import axios from "axios";
// // Importing icons for better visual feedback (You will need to install react-icons)
// import { FiPlus, FiMinus, FiTrash, FiLoader } from 'react-icons/fi'; 

// function Cart() {
//     const navigate = useNavigate();
//     const [cartItems, setCartItems] = useState([]);
//     const [total, setTotal] = useState(0);
//     const [isUpdatingItemId, setIsUpdatingItemId] = useState(null); // New state for loading indicator
...
//             )
//         );
//         setIsUpdatingItemId(id); // Show spinner on this item
...
//         } catch (error) {
//             // 3. ROLLBACK: If request fails, revert state
//             console.error("Error updating item quantity:", error);
//             setCartItems(oldCartItems); 
//             // Optional: Show error message to user
//         } finally {
//             setIsUpdatingItemId(null); // Hide spinner
//         }
//     };
...
//         if (item) {
//             if (item.quantity === 1) {
//                 // If removing entirely, use full removal logic
...
//         setIsUpdatingItemId(idToRemove); // Use ID to show process is running
...
//     // --- Component Render ---
//     const SHIPPING_COST = 0.00; // Assuming free shipping for simplicity
...
//                                 <div
//                                     key={item.id}
//                                     className={`flex flex-col sm:flex-row items-center bg-white border border-gray-200 rounded-xl shadow-md p-4 transition duration-500 relative
//                                         ${isUpdatingItemId === item.id ? 'opacity-50' : ''}`}
//                                 >
//                                     {/* Spinner Overlay */}
//                                     {isUpdatingItemId === item.id && (
//                                         <div className="absolute inset-0 flex items-center justify-center bg-white/70 z-10 rounded-xl">
//                                             <FiLoader className="w-8 h-8 animate-spin text-black" />
//                                         </div>
//                                     )}
...
//                                             className="text-gray-600 hover:text-black p-1 transition disabled:opacity-50"
//                                             disabled={isUpdatingItemId !== null}
//                                         >
//                                             <FiMinus size={18} />
//                                         </button>
...
//                                             className="text-sm text-red-500 hover:text-red-700 font-medium transition flex items-center disabled:opacity-50"
//                                             disabled={isUpdatingItemId !== null}
//                                         >
...
//                                 disabled={cartItems.length === 0 || isUpdatingItemId !== null}
//                                 className={`w-full text-white font-bold py-3 rounded-xl mt-6 transition duration-300 ${
//                                     (cartItems.length > 0 && isUpdatingItemId === null) 
