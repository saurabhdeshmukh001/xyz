...
import { FiDollarSign, FiShoppingCart, FiPackage, FiUsers, FiClock, FiAlertTriangle, FiSettings } from 'react-icons/fi';
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const ordersResponse = await fetch('http://localhost:5001/orders');
