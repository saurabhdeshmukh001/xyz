// // pages/OrderTracking.jsx (Final Refined Version)
// // pages/OrderTracking.jsx (Final Refined Version with Image Fetching)
...
//     if (loading) {
//         return <div className="text-center mt-20 text-xl font-semibold text-gray-700">Loading order details...</div>;
//     }

//     if (error || !order) {
//         return <div className="text-center mt-20 text-2xl font-bold text-red-600">{error}</div>;
//     }
...
//             <Navbar />
//             <div className="max-w-5xl mx-auto p-4 sm:p-6 lg:p-8 mt-10">
...
//                                         {/* FIX: Render actual image or use a text placeholder */}
//                                         {item.image ? (
//                                             <img 
//                                                 src={item.image} 
//                                                 alt={item.name} 
...
// pages/OrderTracking.jsx (Adjusted for Smaller Card Size)
import React, { useState, useEffect } from 'react';
import { useParams, useNavigate } from 'react-router-dom';
import axios from 'axios';
import Navbar from '../components/Navbar';
...
function OrderTracking() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Navbar />
            {/* FIX: Changed max-w-5xl to max-w-3xl for a smaller card size */}
